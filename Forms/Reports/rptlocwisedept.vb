...
Public Class rptlocwisedept
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Payroll_mgmt_sys.rptlocwisedept.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptlocwisedept
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptlocwisedept = New rptlocwisedept
        rpt.Site = Me.Site
        Return rpt
    End Function
