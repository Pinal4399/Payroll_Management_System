...
#End Region
    ...
    Private Sub frm_annexure_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            LoadDefault()
    ...
    Private Sub cmblocnm_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmblocnm.SelectedIndexChanged
    ...
    Private Sub btnreport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnreport.Click
        ...
        strQry = "select e.*,d.department_name from tbl_emp_salaryprocess e,tbl_department d where e.location_id like '" & cmblocnm.SelectedValue & "' and e.department_id like '" & cmbdeptnm.SelectedValue & "' and e.employee_code = '" & cmbempcode.Text.Trim & "' and e.department_id = d.department_id"
        If Not ObjClsGen.Getdata(masterform.con, strQry, m_tbl) Then
            MsgBox("Annexure is not available.", MsgBoxStyle.Information, Me.Text)
        Else
            Dim rptnew As New Reportviewer("annexure", m_tbl)
            rptnew.Show()
        End If
    End Sub
End Class