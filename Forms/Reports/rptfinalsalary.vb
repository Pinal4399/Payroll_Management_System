...
Public Class rptfinalsalary
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Payroll_mgmt_sys.rptfinalsalary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptfinalsalary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptfinalsalary = New rptfinalsalary
        rpt.Site = Me.Site
        Return rpt
    End Function
