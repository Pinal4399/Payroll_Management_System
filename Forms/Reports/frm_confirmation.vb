...
#Region " Events "
    ...
    Private Sub frm_confirmation_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            LoadDefault()
    ...
    Private Sub btnreport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnreport.Click
        ...
        strQry = "select e.*,l.* from tbl_employee e,tbl_location l where e.location_id=l.location_id and e.location_id like '" & cmblocnm.SelectedValue & "'and e.department_id like '" & cmbdeptnm.SelectedValue & "'and e.employee_code like '" & cmbempcode.Text.Trim & "'"
        If ObjClsGen.Getdata(masterform.con, strQry, m_tbl) Then
            Dim rptnew As New Reportviewer("confirmationletter", m_tbl)
            rptnew.Show()
        End If
    End Sub
#End Region
