...
Public Class rptconfirmationletter
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "hr_mgmt_sys.rptconfirmationletter.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptconfirmationletter
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptconfirmationletter = New rptconfirmationletter
        rpt.Site = Me.Site
        Return rpt
    End Function
