...
Public Class rptAppointmentLetterFactory1
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptAppointmentLetterFactory1.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "hr_mgmt_sys.rptAppointmentLetterFactory1.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_m_strIsjoin() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_titleCompanyName() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptAppointmentLetterFactory1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAppointmentLetterFactory1 = New rptAppointmentLetterFactory1
        rpt.Site = Me.Site
        Return rpt
    End Function
