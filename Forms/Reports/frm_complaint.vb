...
#Region " Events "
    ...
    Private Sub complaint_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            LoadDefault()
        Catch ex As Exception
            MsgBox(ex.Message, MsgBoxStyle.Critical, Me.Text)
    ...
    Private Sub btnreport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnreport.Click
        ...
        strQry = "SELECT e.short_name, l.location_id, l.location_name, d.department_id, d.department_name, e1.short_name , e2.short_name,c.* " & _
                 "FROM (((((tbl_location l INNER JOIN " & _
                 "tbl_complaint c ON l.location_id = c.location_id) INNER JOIN " & _
                 "tbl_department d ON c.department_id = d.department_id) INNER JOIN " & _
                 "tbl_employee e ON c.submitted_empcode = e.employee_code) INNER JOIN " & _
                 "tbl_employee e1 ON c.approved_empcode = e1.employee_code) LEFT OUTER JOIN " & _
                 "tbl_employee e2 ON c.resolved_empcode = e2.employee_code)" & _
                 " WHERE c.location_id LIKE '" & cmblocation.SelectedValue & "' AND c.department_id IN(" & strfind & ") "
        ...
        Else
            Dim rptnew As New Reportviewer("Complaint", m_tbl)
            rptnew.Show()
        End If
    End Sub

    Private Sub grid_complaint_DataError(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewDataErrorEventArgs) Handles grid_complaint.DataError
        e.Cancel = True
    End Sub
    ...
    Private Sub chkselected_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles chkselected.CheckedChanged
        Try
            ...
            If chkselected.Checked = True Then
                For Each draw In grid_complaint.Rows
