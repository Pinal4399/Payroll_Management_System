...
Public Class rptsuggestion
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "hr_mgmt_sys.rptsuggestion.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptsuggestion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptsuggestion = New rptsuggestion
        rpt.Site = Me.Site
        Return rpt
    End Function
