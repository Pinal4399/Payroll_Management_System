...
#Region " Events "
    ...
    Private Sub frm_loc_leave_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            LoadDefault()
    ...
    Private Sub grid_leave_DataError(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewDataErrorEventArgs) Handles grid_leave.DataError
        e.Cancel = True
    End Sub
    ...
    Private Sub chkselected_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles chkselected.CheckedChanged
        Try
            ...
            If chkselected.Checked = True Then
                For Each draw In grid_leave.Rows
    ...
    Private Sub btnreport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnreport.Click
        ...
        strQry = "SELECT e.short_name,l.location_id,l.location_name,d.department_id,d.department_name,e1.short_name,lv.* " & _
                         " FROM ((((tbl_location l INNER JOIN " & _
                          "tbl_leave_application lv ON l.location_id = lv.location_id) INNER JOIN " & _
                          "tbl_department d ON lv.department_id = d.department_id) INNER JOIN " & _
                          "tbl_employee e ON lv.employee_code = e.employee_code) INNER JOIN " & _
                          "tbl_employee e1 ON lv.approved_by = e1.employee_code) " & _
                          "WHERE (lv.location_id LIKE '" & cmblocation.SelectedValue & "') and lv.department_id in(" & strfind & ") "
        ...
        Else
            Dim rptnew As New Reportviewer("Leave", m_tbl)
            rptnew.Show()
        End If
    End Sub
#End Region
