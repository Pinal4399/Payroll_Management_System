...
#Region " Events "
    Private Sub frm_employeelist_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            LoadDefault()
    ...
    Private Sub chkselected_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles chkselected.CheckedChanged
        Try
            ...
            If chkselected.Checked = True Then
                For Each draw In grid_employee.Rows
    ...
    Private Sub grid_employee_DataError(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewDataErrorEventArgs) Handles grid_employee.DataError
        e.Cancel = True
    End Sub
    ...
    Private Sub btnreport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnreport.Click
        ...
        If rdactive.Checked Then
            strQry = "select e.*,l.location_name,d.department_name from tbl_employee e,tbl_location l,tbl_department d where e.location_id=l.location_id and e.department_id=d.department_id and e.location_id like '" & cmblocation.SelectedValue & "' and e.department_id in(" & strfind & ") and emp_inactive = 0"
            If Not ObjClsGen.Getdata(masterform.con, strQry, m_tbl) Then
                MsgBox("There are no records", MsgBoxStyle.Information, Me.Text)
            Else
                Dim rptnew As New Reportviewer("active_employees", m_tbl)
                rptnew.Show()
            End If
        ElseIf rdinactive.Checked Then
            strQry = "select e.*,l.location_name,d.department_name from tbl_employee e,tbl_location l,tbl_department d where e.location_id=l.location_id and e.department_id=d.department_id and e.location_id like '" & cmblocation.SelectedValue & "' and e.department_id in(" & strfind & ") and emp_inactive = 1"
            If Not ObjClsGen.Getdata(masterform.con, strQry, m_tbl) Then
                ' If strfind = String.Empty Then
                MsgBox("There are no records", MsgBoxStyle.Information, Me.Text)
            Else
                '  End If
                Dim rptnew As New Reportviewer("inactive_employees", m_tbl)
                rptnew.Show()
            End If
        Else
            strQry = "select e.*,l.location_name,d.department_name from tbl_employee e,tbl_location l,tbl_department d where e.location_id=l.location_id and e.department_id=d.department_id and e.location_id like '" & cmblocation.SelectedValue & "' and e.department_id in(" & strfind & ") "
            If Not ObjClsGen.Getdata(masterform.con, strQry, m_tbl) Then
                ' If strfind = String.Empty Then
                MsgBox("There are no records", MsgBoxStyle.Information, Me.Text)
            Else
