...
#Region " Events "
    ...
    Private Sub btnreport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnreport.Click
        ...
        strQry = "SELECT e.short_name, l.location_id, l.location_name, d.department_id, d.department_name, e1.short_name ,s.* " & _
                 "FROM ((((tbl_location l INNER JOIN " & _
                 "tbl_suggestion s ON l.location_id = s.location_id) INNER JOIN " & _
                 "tbl_department d ON s.department_id = d.department_id) INNER JOIN " & _
                 "tbl_employee e ON s.submitted_empcode = e.employee_code) INNER JOIN " & _
                 "tbl_employee e1 ON s.approved_empcode = e1.employee_code) " & _
                 " WHERE s.location_id LIKE '" & cmblocation.SelectedValue & "' AND s.department_id IN(" & strfind & ") "
        ...
        Else
            Dim rptnew As New Reportviewer("Suggestion", m_tbl)
            rptnew.Show()
        End If
    End Sub

    Private Sub frm_suggestion_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            LoadDefault()
        Catch ex As Exception
            MsgBox(ex.Message, MsgBoxStyle.Critical, Me.Text)
    ...
    Private Sub grid_suggestion_DataError(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewDataErrorEventArgs) Handles grid_suggestion.DataError
        e.Cancel = True
    End Sub
    ...
    Private Sub chkselected_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles chkselected.CheckedChanged
        Try
            ...
            If chkselected.Checked = True Then
                For Each draw In grid_suggestion.Rows
